<template>
	<Card class="h-64 flex flex-col min-w-64 transition-all duration-300 cursor-pointer shadow-md hover:shadow-xl">
		<ThemeImage
		...
		<CardContent>
			...
			<div class="text-sm mt-4">
				...
				<p>Docking Access: {{ $t("carrier.dockingaccess." + carrier.dockingAccess) }}</p>
			</div>
		</CardContent>
	</Card>
</template>
